...
row, col, adjacent_matrix = readFile("map_1.txt")
...
turtle.register_shape("image/wall_img.gif")
...
x_pacman, y_pacman, x_food, y_food = 0, 0, 0, 0
...
sea.Astar_Level1(adjacent_matrix, visited, pathVisited, x_pacman, y_pacman, x_food, y_food)
...
f1 = open("path_discorved/output_level1.txt", "a")
f1.write("Path discovered of level 1: ")
f1.write(str(BackTrack))
f1.write('\n')
f1.write("The length of the discovered paths in level 1: ")
...
def eat():
    for food in foods:
        if pacman.is_collision(food):
            ...
            f2 = open("path_discorved/output_level1.txt", "a")
            f2.write("Point of pacman in level 1: ")
...
def mainLevel1():
    ...
    while True:
        ...
        f3 = open("path_discorved/output_level1.txt", "a")
        f3.write("Time to finish in level 1: ")
        f3.write(str(delta))
        f3.write("s")
        f3.close()
        wn.tracer(0)
